...
package moviesdwh_etl.moviedim_0_1;
...
/**
 * Job: MovieDim Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class MovieDim implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "MovieDim";
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(MovieDim.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class out2Struct implements routines.system.IPersistableRow<out2Struct> {
    final static byte[] commonByteArrayLock_MOVIESDWH_ETL_MovieDim = new byte[0];
    static byte[] commonByteArray_MOVIESDWH_ETL_MovieDim = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_MOVIESDWH_ETL_MovieDim.length) {
				if(length < 1024 && commonByteArray_MOVIESDWH_ETL_MovieDim.length == 0) {
   					commonByteArray_MOVIESDWH_ETL_MovieDim = new byte[1024];
				} else {
   					commonByteArray_MOVIESDWH_ETL_MovieDim = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_MOVIESDWH_ETL_MovieDim, 0, length);
			strReturn = new String(commonByteArray_MOVIESDWH_ETL_MovieDim, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_MOVIESDWH_ETL_MovieDim, 0, length);
			strReturn = new String(commonByteArray_MOVIESDWH_ETL_MovieDim, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_MOVIESDWH_ETL_MovieDim) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.genre_name = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.genre_name,dos);
    ...
    public String toString() {
		...
		sb.append(",genre_name="+genre_name);
...
if(dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
	tableName_tDBOutput_1 = ("moviedim");
} else {
	tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "\".\"" + ("moviedim");
}
...
String dbUser_tDBOutput_1 = null;
	...
	final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:fZghzw4HA2BxQtzon8RCROVlM9Q/UKiv9c2PQforfS8=");
...
int count_tDBOutput_1=0;
	    String insert_tDBOutput_1 = "INSERT INTO \"" + tableName_tDBOutput_1 + "\" (\"movie_bk\",\"movie_title\",\"movie_genre\",\"movie_language_code\",\"movie_runtim\",\"movie_budget\",\"movie_overview\",\"movie_release_date\") VALUES (?,?,?,?,?,?,?,?)";
 					    ...
 					    boolean forceLooprow3 = false;
 							...
 							row3Struct row3ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_1 = false;
                        		    		    ...
                        		    		    row3HashKey.genre_id = row2.genre_id ;
...
out1_tmp.genre_name = row3.genre_name ;
out1_tmp.runtime = row1.runtime ;
out1_tmp.budget = row1.budget ;
out1_tmp.overview = row1.overview ;
 					    ...
 					    boolean forceLooprow5 = false;
 							...
 							row5Struct row5ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_2 = false;
                        		    		    ...
                        		    		    row5HashKey.language_id = row4.language_id ;
				           		...
				           		if(tHash_Lookup_row5 != null && tHash_Lookup_row5.getCount(row5HashKey) > 1) { // G 071
									...
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row5' and it contains more one result from keys :  row5.language_id = '" + row5HashKey.language_id + "'");
								} // G 071
...
out2_tmp.title = out1.title ;
out2_tmp.genre_name = out1.genre_name ;
out2_tmp.language_code = row5.language_code ;
out2_tmp.runtime = out1.runtime ;
out2_tmp.budget = out1.budget ;
out2_tmp.overview = out1.overview ;
...
if(out2 != null) { 
	...
	currentComponent="tDBOutput_1";
        ...
        whetherReject_tDBOutput_1 = false;
                    if(out2.movie_id == null) {
pstmt_tDBOutput_1.setNull(1, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_1.setInt(1, out2.movie_id);
}

                    if(out2.title == null) {
pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(2, out2.title);
}

                    if(out2.genre_name == null) {
pstmt_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(3, out2.genre_name);
}

                    if(out2.language_code == null) {
pstmt_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(4, out2.language_code);
}

                    if(out2.runtime == null) {
pstmt_tDBOutput_1.setNull(5, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_1.setInt(5, out2.runtime);
}

                    if(out2.budget == null) {
pstmt_tDBOutput_1.setNull(6, java.sql.Types.DOUBLE);
} else {pstmt_tDBOutput_1.setDouble(6, out2.budget);
}

                    if(out2.overview == null) {
pstmt_tDBOutput_1.setNull(7, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(7, out2.overview);
}

                    if(out2.release_date != null) {
pstmt_tDBOutput_1.setTimestamp(8, new java.sql.Timestamp(out2.release_date.getTime()));
} else {
...
public static class row2Struct implements routines.system.IPersistableComparableLookupRow<row2Struct> {
    ...
    public void readValuesData(DataInputStream dis, ObjectInputStream ois) {
        try {
			...
			int length = 0;
						...
						this.genre_id = readInteger(dis,ois);
    ...
    public void readValuesData(DataInputStream dis, org.jboss.marshalling.Unmarshaller objectIn) {
        try {
			int length = 0;
						...
						this.genre_id = readInteger(dis,objectIn);
    ...
    public void writeValuesData(DataOutputStream dos, ObjectOutputStream oos) {
        try {
					...
					writeInteger(this.genre_id, dos, oos);
    ...
    public void writeValuesData(DataOutputStream dos, org.jboss.marshalling.Marshaller objectOut){
                try {
					...
					writeInteger(this.genre_id, dos, objectOut);
    ...
    public String toString() {
		...
		sb.append("_id="+_id);
		sb.append(",movie_id="+String.valueOf(movie_id));
		sb.append(",genre_id="+String.valueOf(genre_id));
		sb.append(",indate="+String.valueOf(indate));
	    sb.append("]");
...
final String applicationName_tMongoDBInput_2 = "Talend";
    ...
    com.mongodb.client.MongoDatabase db_tMongoDBInput_2=null;
        ...
        db_tMongoDBInput_2 = mongo_tMongoDBInput_2.getDatabase("MoviesStagingArea");
					...
					com.mongodb.client.MongoCollection<org.bson.Document> coll_tMongoDBInput_2 = db_tMongoDBInput_2.getCollection("movie_genres");
				...
				pathMap_tMongoDBInput_2.put("genre_id","");
				...
				if(valueObj_tMongoDBInput_2!=null && valueObj_tMongoDBInput_2.toString().length() > 0) {
                    ...
                    valueObj_tMongoDBInput_2=dbObjectInputUtil_tMongoDBInput_2.getValue(pathMap_tMongoDBInput_2.get("genre_id"),"genre_id",o_tMongoDBInput_2);
				if(valueObj_tMongoDBInput_2!=null && valueObj_tMongoDBInput_2.toString().length() > 0) {
                            if (valueObj_tMongoDBInput_2.getClass().equals(Double.class)) {
                                row2.genre_id = ParserUtils.parseTo_Double(valueObj_tMongoDBInput_2.toString()).intValue();
                            } else {
                                row2.genre_id = ParserUtils.parseTo_Integer(valueObj_tMongoDBInput_2.toString());
                            }
				}else{
					row2.genre_id = null;
				}
 ...
 */
	...
	currentComponent="tAdvancedHash_row2";
				...
				row2_HashRow.genre_id = row2.genre_id;
...
public static class row3Struct implements routines.system.IPersistableComparableLookupRow<row3Struct> {
	...
	public int hashCode() {
		if (this.hashCodeDirty) {
			...
			int result = DEFAULT_HASHCODE;
						...
						result = prime * result + ((this.genre_id == null) ? 0 : this.genre_id.hashCode());
	...
	public boolean equals(Object obj) {
		...
		final row3Struct other = (row3Struct) obj;
						...
						} else if (!this.genre_id.equals(other.genre_id))
    ...
    public void writeKeysData(ObjectOutputStream dos) {
        try {
					...
					// Integer
						...
						writeInteger(this.genre_id,dos);
    ...
    public void readValuesData(DataInputStream dis, ObjectInputStream ois) {
        try {
			...
			int length = 0;
						...
						this.genre_name = readString(dis,ois);
    ...
    public void readValuesData(DataInputStream dis, org.jboss.marshalling.Unmarshaller objectIn) {
        try {
			int length = 0;
						...
						this.genre_name = readString(dis,objectIn);
    ...
    public void writeValuesData(DataOutputStream dos, ObjectOutputStream oos) {
        try {
						...
						writeString(this.genre_name, dos, oos);
    ...
    public void writeValuesData(DataOutputStream dos, org.jboss.marshalling.Marshaller objectOut){
                try {
						...
						writeString(this.genre_name, dos, objectOut);
    ...
    public int compareTo(row3Struct other) {
		...
		int returnValue = -1;
						...
						returnValue = checkNullsAndCompare(this.genre_id, other.genre_id);
						if(returnValue != 0) {
							return returnValue;
						}
...
final String applicationName_tMongoDBInput_3 = "Talend";
    ...
    com.mongodb.client.MongoDatabase db_tMongoDBInput_3=null;
        ...
        db_tMongoDBInput_3 = mongo_tMongoDBInput_3.getDatabase("MoviesStagingArea");
					...
					com.mongodb.client.MongoCollection<org.bson.Document> coll_tMongoDBInput_3 = db_tMongoDBInput_3.getCollection("genre");
				...
				pathMap_tMongoDBInput_3.put("genre_id","");
				pathMap_tMongoDBInput_3.put("genre_name","");
				...
				row3._id = valueObj_tMongoDBInput_3==null ? null : valueObj_tMongoDBInput_3.toString();
                    ...
                    valueObj_tMongoDBInput_3=dbObjectInputUtil_tMongoDBInput_3.getValue(pathMap_tMongoDBInput_3.get("genre_id"),"genre_id",o_tMongoDBInput_3);
				if(valueObj_tMongoDBInput_3!=null && valueObj_tMongoDBInput_3.toString().length() > 0) {
                            if (valueObj_tMongoDBInput_3.getClass().equals(Double.class)) {
                                row3.genre_id = ParserUtils.parseTo_Double(valueObj_tMongoDBInput_3.toString()).intValue();
                            } else {
                                row3.genre_id = ParserUtils.parseTo_Integer(valueObj_tMongoDBInput_3.toString());
                            }
				}else{
					row3.genre_id = null;
				}
                    valueObj_tMongoDBInput_3=dbObjectInputUtil_tMongoDBInput_3.getValue(pathMap_tMongoDBInput_3.get("genre_name"),"genre_name",o_tMongoDBInput_3);
					
				row3.genre_name = valueObj_tMongoDBInput_3==null ? null : valueObj_tMongoDBInput_3.toString();
 ...
 */
	...
	currentComponent="tAdvancedHash_row3";
				...
				row3_HashRow.genre_id = row3.genre_id;
				
				row3_HashRow.genre_name = row3.genre_name;
...
final String applicationName_tMongoDBInput_4 = "Talend";
    ...
    com.mongodb.client.MongoDatabase db_tMongoDBInput_4=null;
        ...
        db_tMongoDBInput_4 = mongo_tMongoDBInput_4.getDatabase("MoviesStagingArea");
					...
					com.mongodb.client.MongoCollection<org.bson.Document> coll_tMongoDBInput_4 = db_tMongoDBInput_4.getCollection("movie_languages");
				...
				pathMap_tMongoDBInput_4.put("language_id","");
				pathMap_tMongoDBInput_4.put("language_role_id","");
				...
				if(valueObj_tMongoDBInput_4!=null && valueObj_tMongoDBInput_4.toString().length() > 0) {
                    ...
                    valueObj_tMongoDBInput_4=dbObjectInputUtil_tMongoDBInput_4.getValue(pathMap_tMongoDBInput_4.get("language_id"),"language_id",o_tMongoDBInput_4);
				if(valueObj_tMongoDBInput_4!=null && valueObj_tMongoDBInput_4.toString().length() > 0) {
                            if (valueObj_tMongoDBInput_4.getClass().equals(Double.class)) {
                                row4.language_id = ParserUtils.parseTo_Double(valueObj_tMongoDBInput_4.toString()).intValue();
                            } else {
                                row4.language_id = ParserUtils.parseTo_Integer(valueObj_tMongoDBInput_4.toString());
                            }
				}else{
					row4.language_id = null;
				}
                    valueObj_tMongoDBInput_4=dbObjectInputUtil_tMongoDBInput_4.getValue(pathMap_tMongoDBInput_4.get("language_role_id"),"language_role_id",o_tMongoDBInput_4);
				if(valueObj_tMongoDBInput_4!=null && valueObj_tMongoDBInput_4.toString().length() > 0) {
                            if (valueObj_tMongoDBInput_4.getClass().equals(Double.class)) {
                                row4.language_role_id = ParserUtils.parseTo_Double(valueObj_tMongoDBInput_4.toString()).intValue();
                            } else {
                                row4.language_role_id = ParserUtils.parseTo_Integer(valueObj_tMongoDBInput_4.toString());
                            }
				}else{
					row4.language_role_id = null;
				}
 ...
 */
	...
	currentComponent="tAdvancedHash_row4";
				...
				row4_HashRow.language_id = row4.language_id;
				
				row4_HashRow.language_role_id = row4.language_role_id;
...
public static class row5Struct implements routines.system.IPersistableComparableLookupRow<row5Struct> {
	...
	public int hashCode() {
		if (this.hashCodeDirty) {
			...
			int result = DEFAULT_HASHCODE;
						...
						result = prime * result + ((this.language_id == null) ? 0 : this.language_id.hashCode());
	...
	public boolean equals(Object obj) {
		...
		final row5Struct other = (row5Struct) obj;
						...
						} else if (!this.language_id.equals(other.language_id))
	...
	public void copyDataTo(row5Struct other) {
		...
		other._id = this._id;
	            ...
	            other.language_name = this.language_name;
		...
		synchronized(commonByteArrayLock_MOVIESDWH_ETL_MovieDim) {
        	...
        	try {
        		...
        		int length = 0;
						...
						this.language_id = readInteger(dis);
    ...
    public void writeKeysData(ObjectOutputStream dos) {
        try {
					...
					// Integer
						...
						writeInteger(this.language_id,dos);
    ...
    public void readValuesData(DataInputStream dis, ObjectInputStream ois) {
        try {
			...
			int length = 0;
						...
						this.language_code = readString(dis,ois);
					
						this.language_name = readString(dis,ois);
    ...
    public void readValuesData(DataInputStream dis, org.jboss.marshalling.Unmarshaller objectIn) {
        try {
			int length = 0;
						...
						this.language_code = readString(dis,objectIn);
					
						this.language_name = readString(dis,objectIn);
    ...
    public void writeValuesData(DataOutputStream dos, ObjectOutputStream oos) {
        try {
						...
						writeString(this.language_code, dos, oos);
					
						writeString(this.language_name, dos, oos);
    ...
    public void writeValuesData(DataOutputStream dos, org.jboss.marshalling.Marshaller objectOut){
                try {
						...
						writeString(this.language_code, dos, objectOut);
					
						writeString(this.language_name, dos, objectOut);
    ...
    public String toString() {
		...
		sb.append(",language_id="+String.valueOf(language_id));
		sb.append(",language_code="+language_code);
		sb.append(",language_name="+language_name);
	    sb.append("]");
    ...
    public int compareTo(row5Struct other) {
		...
		int returnValue = -1;
						...
						returnValue = checkNullsAndCompare(this.language_id, other.language_id);
						if(returnValue != 0) {
							return returnValue;
						}
...
final String applicationName_tMongoDBInput_5 = "Talend";
    ...
    com.mongodb.client.MongoDatabase db_tMongoDBInput_5=null;
        ...
        db_tMongoDBInput_5 = mongo_tMongoDBInput_5.getDatabase("MoviesStagingArea");
					...
					com.mongodb.client.MongoCollection<org.bson.Document> coll_tMongoDBInput_5 = db_tMongoDBInput_5.getCollection("language");
				...
				pathMap_tMongoDBInput_5.put("language_id","");
				pathMap_tMongoDBInput_5.put("language_code","");
				pathMap_tMongoDBInput_5.put("language_name","");
				...
				row5._id = valueObj_tMongoDBInput_5==null ? null : valueObj_tMongoDBInput_5.toString();
                    ...
                    valueObj_tMongoDBInput_5=dbObjectInputUtil_tMongoDBInput_5.getValue(pathMap_tMongoDBInput_5.get("language_id"),"language_id",o_tMongoDBInput_5);
				if(valueObj_tMongoDBInput_5!=null && valueObj_tMongoDBInput_5.toString().length() > 0) {
                            if (valueObj_tMongoDBInput_5.getClass().equals(Double.class)) {
                                row5.language_id = ParserUtils.parseTo_Double(valueObj_tMongoDBInput_5.toString()).intValue();
                            } else {
                                row5.language_id = ParserUtils.parseTo_Integer(valueObj_tMongoDBInput_5.toString());
                            }
				}else{
					row5.language_id = null;
				}
                    valueObj_tMongoDBInput_5=dbObjectInputUtil_tMongoDBInput_5.getValue(pathMap_tMongoDBInput_5.get("language_code"),"language_code",o_tMongoDBInput_5);
					
				row5.language_code = valueObj_tMongoDBInput_5==null ? null : valueObj_tMongoDBInput_5.toString();
				
                    valueObj_tMongoDBInput_5=dbObjectInputUtil_tMongoDBInput_5.getValue(pathMap_tMongoDBInput_5.get("language_name"),"language_name",o_tMongoDBInput_5);
					
				row5.language_name = valueObj_tMongoDBInput_5==null ? null : valueObj_tMongoDBInput_5.toString();
 ...
 */
	...
	currentComponent="tAdvancedHash_row5";
				...
				row5_HashRow.language_id = row5.language_id;
				
				row5_HashRow.language_code = row5.language_code;
				
				row5_HashRow.language_name = row5.language_name;
 ...
 */
    ...
    public static void main(String[] args){
        final MovieDim MovieDimClass = new MovieDim();

        int exitCode = MovieDimClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = MovieDim.class.getClassLoader().getResourceAsStream("moviesdwh_etl/moviedim_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = MovieDim.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : MovieDim");
        }
...
/************************************************************************************************
 *     217574 characters generated by Talend Open Studio for Big Data 
 *     on the December 7, 2023 at 2:04:48 PM EET
 ************************************************************************************************/